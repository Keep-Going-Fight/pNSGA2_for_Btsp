...
"""
Loader datasets  --  file operation
"""
...
class Loader:
    ...
    def __init__(self, unit_test=False):
        ...
        #self.path_dist = './../datasets/randomA100.tsp'
        #self.path_cost = './../datasets/randomB100.tsp'
        #self.path_dist = './../datasets/randomC100.tsp'
        #self.path_cost = './../datasets/randomD100.tsp'
        
        #self.o1_path = './../datasets/euclidA100.tsp'
        #self.o2_path = './../datasets/euclidB100.tsp'
        #self.o1_path = './../datasets/euclidE100.tsp'
        #self.o2_path = './../datasets/euclidF100.tsp'
        #self.o1_path = './../datasets/euclidC100.tsp'
        #self.o2_path = './../datasets/euclidD100.tsp'
        
        #self.o1_path = './../datasets/randomC100.tsp'
        #self.o2_path = './../datasets/randomD100.tsp'
        
        #self.o1_path = './../datasets/kroA150.tsp'
        #self.o2_path = './../datasets/kroB150.tsp'
        #self.o1_path = './../datasets/kroA200.tsp'
        #self.o2_path = './../datasets/kroB200.tsp'
        #self.front_path = './../datasets/best.euclidAB100.tsp'
        #self.front_path = './../datasets/best.euclidAB100.tsp'
        
        #self.o1_path = './../datasets/kroA100.tsp'
        #self.o1_path = './../datasets/kroB100.tsp'
        #self.o1_path = './../datasets/kroC100.tsp'
        self.o1_path = './../datasets/kroD100.tsp'
        self.o2_path = './../datasets/kroE100.tsp'
    ...
    def load_dataset_a(self):
        distances = np.zeros((self.n_cities_a, self.n_cities_a), dtype='uint16')#initialize zero 48*100 matric
        costs = np.zeros((self.n_cities_a, self.n_cities_a), dtype='uint16')#initialize zero 48*100 matric
        with open(self.path_dist, "rt") as in_file:#read distance file
            dist_t = in_file.read()
        with open(self.path_cost, "rt") as in_file:#read cost file
            cost_t = in_file.read()
        dist_rows = dist_t.split("\n")#removed \n
        cost_rows = cost_t.split("\n")

        for i in range(self.n_cities_a):
            dist_cols = dist_rows[i].split("\t")[:i + 1]#if \t ,then partition
